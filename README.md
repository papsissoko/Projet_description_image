...
Ce  petit projet est une impléméntation  des  techniques pour la description  des images. 


**Premier model : Basé sur CNN+LSTM** 
    ...
    *Le Modèle d'IA utilisée est composée de* :  
       ...
       LSTM : l'objectif du LSTM est de dire la phrase qui correspond à  une phrase, à partir de ce qui a été appris par le CNN. 
        ...
        Ici  dans ce modèle le CNN joue le rôle de yeux alors que le LSTM joue en une sorte le cerveau et  de la bouche.
        Et la Tokenization  et l'embedding peuvent  être           interprété comme les transmetteurs des signaux des yeux aux cerveaux. 

**Deuxième modèle**
    Le deuxième modèle est **VIT** pour Vision Transformer bbasé sur un  transformer constitué d'un encoder-decoder pour générer du  texte.
